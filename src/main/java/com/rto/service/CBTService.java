...
public class CBTService implements IService {
     ...
     */
    public CBTResult evaluateTest(String userId, Map<String, String> answers) {
        ...
        System.out.println(passed ? 
            "✅ Test PASSED: " + correctCount + "/" + totalQuestions + " (" + scorePercentage + "%)" :
    ...
    private void seedQuestions() {
        ...
        String[][] questions = {
            {"Q001", "What does a red traffic light mean?", "Go", "Stop", "Slow down", "Wait", "B", "TRAFFIC_SIGNS"},
            {"Q002", "Maximum speed limit in school zone?", "40 km/h", "50 km/h", "25 km/h", "60 km/h", "C", "SPEED_LIMITS"},
            {"Q003", "When must you use headlights?", "Daytime", "Night time", "Always", "Never", "B", "ROAD_SAFETY"},
            {"Q004", "What does a yellow traffic light indicate?", "Stop", "Go fast", "Prepare to stop", "Turn left", "C", "TRAFFIC_SIGNS"},
            {"Q005", "Minimum age for obtaining a Learner's License?", "16 years", "18 years", "21 years", "25 years", "A", "RULES"},
            {"Q006", "What should you do at a STOP sign?", "Slow down", "Come to complete stop", "Honk", "Speed up", "B", "TRAFFIC_SIGNS"},
            {"Q007", "Wearing helmet is mandatory for?", "Driver only", "Pillion only", "Both", "None", "C", "ROAD_SAFETY"},
            {"Q008", "What does a triangular sign indicate?", "Stop", "Give way", "No entry", "Speed limit", "B", "TRAFFIC_SIGNS"},
            {"Q009", "Safe following distance on highway?", "1 car length", "2 car lengths", "3-4 car lengths", "No distance needed", "C", "ROAD_SAFETY"},
            {"Q010", "What is the legal blood alcohol limit?", "0.03%", "0.05%", "0.00%", "0.08%", "C", "RULES"},
            {"Q011", "Overtaking from left side is?", "Allowed", "Not allowed", "Allowed on highway", "Depends  on road", "B", "ROAD_RULES"},
            {"Q012", "Use of mobile phone while driving is?", "Allowed", "Prohibited", "Allowed handsfree", "Depends", "B", "ROAD_SAFETY"},
            {"Q013", "Pedestrians have right of way at?", "Anywhere", "Zebra crossing", "Roads", "Highways", "B", "ROAD_RULES"},
            {"Q014", "What does a circular sign with red border mean?", "Mandatory", "Prohibitory", "Informatory", "Warning", "B", "TRAFFIC_SIGNS"},
            {"Q015", "Seatbelt is mandatory for?", "Front seat only", "All passengers", "Driver only", "Optional", "B", "ROAD_SAFETY"}
        };
